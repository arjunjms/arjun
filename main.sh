...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To JMS STORE SCRIPT ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}JMS STORE ® ${NC}${YELLOW}(${NC} ${green} JMS STORE TUNNELING ${NC}${YELLOW})${NC}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/arjunjms/arjun/main/"
...
clear
izinsc="https://raw.githubusercontent.com/arjunjms/izin/main/ipvps"
# USERNAME
rm -f /usr/bin/user
...
<code>────────────────────</code>
<b> JMS STORE TUNNEL SCRIPT  </b>
<code>────────────────────</code>
<i>Automatic Notifications From Github</i>
"'&reply_markup={"inline_keyboard":[[{"text":"Order","url":"https://t.me/BogelStore1"},{"text":"Grub Tele","url":"https://t.me/BogelChannel"}]]}'
...
wget -q https://raw.githubusercontent.com/arjunjms/arjun/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
rm -rf /root/LICENSE.MD
rm -rf /root/README.MD
rm -rf /root/noobzvpn.service
rm -rf /root/noobzvpn.x86_64
